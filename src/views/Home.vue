    ...
    <section class="slider-wrapper">
      ...
      >
        ...
        <div class="carousel-inner">
          ...
          >
            <img
              :src="require('@/assets/' + slide.imgSrc)"
              class="d-block w-100"
              alt="Slider"
            />
            <div class="overlay">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 adv-col">
              ...
              <q>
                As VPN services go, it's hard to beat NordVPN. It has a large
                and diverse collection of servers, an excellent collection of
                advanced features, strong privacy and security
              </q>
              <div class="adv-ow">
